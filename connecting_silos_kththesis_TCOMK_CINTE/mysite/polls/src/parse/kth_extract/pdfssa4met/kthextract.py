       ...
       # print args[0]
        ...
        for folder in file_list:
          if folder!="cache" and folder!="log.txt" and folder != "test_log.txt":
            ...
            if folder_name[1].lower()==author_1.lower() or folder_name[2].lower()==author_1.lower() or folder_name[1].lower()==author_2.lower() or folder_name[2].lower() ==author_2.lower():
                my_id=folder_name[3]
